...
package edu.bupt.mms.dom.smil.parser;
...
import edu.bupt.mms.dom.smil.parser.SmilContentHandler;
...
public class SmilXmlParser {
    ...
    private void validateDocument(SMILDocument doc) {
         ...
         * @see edu.bupt.mms.dom.smil.SmilDocumentImpl#getBody()
         */
        doc.getBody();

        /*
         * Calling getLayout() will create "layout" element if it is not present.
         * @see edu.bupt.mms.dom.smil.SmilDocumentImpl#getLayout()
         */
        doc.getLayout();
    }
}
