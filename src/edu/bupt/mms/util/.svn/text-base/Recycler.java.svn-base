...
public abstract class Recycler {
    ...
    public abstract int getSmsPriority(Context paramContext);
    public abstract void setSmsPriority(Context paramContext, int paramInt);
    ...
    public static class SmsRecycler extends Recycler {
        ...
        public int getSmsPriority(Context paramContext)
        {
          SharedPreferences localSharedPreferences = PreferenceManager.getDefaultSharedPreferences(paramContext);
          return Settings.System.getInt(paramContext.getContentResolver(), "SMS_PRIORITY", localSharedPreferences.getInt("SmsPriority", 0));
        }
        
        
        
        public void setSmsPriority(Context paramContext, int paramInt)
        {
         
         
            SharedPreferences.Editor localEditor = PreferenceManager.getDefaultSharedPreferences(paramContext).edit();
            localEditor.putInt("SmsPriority", paramInt);
            localEditor.commit();
          
          Settings.System.putInt(paramContext.getContentResolver(), "SMS_PRIORITY", paramInt);
        }
