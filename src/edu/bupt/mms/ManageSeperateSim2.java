 ...
 */
public class ManageSeperateSim2 extends Activity implements
		View.OnCreateContextMenuListener {
	private static final Uri ICC_URI = Uri.parse("content://sms/icc");
	private static final Uri ICC_URI2 = Uri.parse("content://sms/icc2");
	private static final String TAG = "ManageSeperateSim2";
	...
	private class QueryHandler extends AsyncQueryHandler {
		private final ManageSeperateSim2 mParent;

		public QueryHandler(ContentResolver contentResolver,
				ManageSeperateSim2 parent) {
