...
public class PreferenceSim2Activity extends PreferenceActivity implements
OnPreferenceChangeListener {
	...
	private void loadPrefs() {
		addPreferencesFromResource(R.xml.preferences_sim2);
