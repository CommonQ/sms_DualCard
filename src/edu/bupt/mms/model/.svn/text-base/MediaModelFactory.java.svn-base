...
import edu.bupt.mms.dom.smil.SMILMediaElement;
import edu.bupt.mms.dom.smil.SMILRegionElement;
import edu.bupt.mms.dom.smil.SMILRegionMediaElement;
import edu.bupt.mms.dom.smil.Time;
import edu.bupt.mms.dom.smil.TimeList;
    ...
    private static MediaModel getGenericMediaModel(Context context,
        ...
        //zaizhe
            ...
            media = new VCardModel(context, contentType, src,
                    part.getDataUri());
            Log.v(TAG, "zhixingle!! :"+ part.getDataUri());
            ...
            //zaizhe
            else if (ContentType.TEXT_VCARD.equalsIgnoreCase(contentType)) {
                media = new VCardModel(context, contentType, src,
                        part.getDataUri());
                Log.v(TAG, "zhixingle!! :"+ part.getDataUri());
