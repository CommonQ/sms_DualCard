...
import edu.bupt.mms.model.LayoutModel;
import edu.bupt.mms.model.MediaModel;
import edu.bupt.mms.model.Model;
import edu.bupt.mms.model.RegionMediaModel;
import edu.bupt.mms.model.RegionModel;
...
import edu.bupt.mms.model.MediaModel.MediaAction;
import edu.bupt.mms.ui.AdaptableSlideViewInterface.OnSizeChangedListener;
...
public class SlideshowPresenter extends Presenter {
    ...
    protected void presentSlide(SlideViewInterface view, SlideModel model) {
        ...
        for (MediaModel media : model) {
            ...
            //zaizhe
            	...
            	Log.v(TAG, "yunxingle!!");
                presentVcard(view, (VCardModel) media, false);
            }
    ...
    //zaizhe
    protected void presentVcard(SlideViewInterface view, VCardModel audio,
            boolean dataChanged) {
    	
    	Log.v(TAG, "dataChanged: "+dataChanged);
        // Set audio only when data changed.
        if (dataChanged) {
            view.setAudio(audio.getUri(), audio.getSrc(), audio.getExtras());
        }
