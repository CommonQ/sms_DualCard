...
public class ConversationListAdapter1 extends CursorAdapter implements AbsListView.RecyclerListener {
    ...
    public ConversationListAdapter1(Context context, Cursor cursor) {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        if (!(view instanceof ConversationListItem1)) {
            Log.e(TAG, "Unexpected bound view: " + view);
            return;
        }

        ConversationListItem1 headerView = (ConversationListItem1) view;
    ...
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        ...
        return mFactory.inflate(R.layout.conversation_list_item1, parent, false);
    }

    public interface OnContentChangedListener {
        void onContentChanged(ConversationListAdapter1 adapter);
    }
