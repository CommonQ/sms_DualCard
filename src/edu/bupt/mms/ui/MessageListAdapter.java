...
public class MessageListAdapter extends CursorAdapter {
    ...
    static final String[] PROJECTION = new String[] {
        // TODO: should move this symbol into edu.bupt.mms.telephony.Telephony.
...
//            
//            String service_center_address =  cursor.getString(cursor.getColumnIndex("service_center_address"));
//            
//            Log.v("MessageListAdapter", "status: "+status+" type: "+type+" service_center_address: "+service_center_address+" msgId: "+msgId);
//            
    ...
    public MessageItem getCachedMessageItem(String type, long msgId, Cursor c) {
        ...
        if (item == null && c != null && isCursorValid(c)) {
            try {
                ...
                Log.v("MessageListAdapter", "item.mType: "+item.mType+"item.mMsgId: "+item.mMsgId);
