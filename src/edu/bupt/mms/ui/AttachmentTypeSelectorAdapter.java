...
public class AttachmentTypeSelectorAdapter extends IconListAdapter {
    ...
    public final static int ADD_CALENDAR            = 7;
    
    public final static int ADD_RELATIVES            = 8;
    ...
    protected static List<IconListItem> getData(int mode, Context context) {
        ...
        addItem(data, "添加日程",
                R.drawable.ic_attach_picture_holo_light, ADD_CALENDAR);
        
        addItem(data, "添加联系人信息",
                R.drawable.ic_attach_picture_holo_light, ADD_RELATIVES);
