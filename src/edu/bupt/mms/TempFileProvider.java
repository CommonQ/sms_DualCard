...
public class TempFileProvider extends ContentProvider {
    ...
    public static String getScrapPath(Context context, String fileName) {
    	Log.v("TempFilePrvodier",  context.getExternalCacheDir().getAbsolutePath() + "/" + fileName);
    ...
    public static Uri renameScrapFile(String fileExtension, String uniqueIdentifier,
      ...
      //  String filePath = getScrapPath(context);
        ...
        String filePath="/storage/sdcard0/Android/data/com.android.mms/cache/.temp.jpg";
        
        Log.v("TempFileProvider", "filePath: "+filePath);
        ...
        Log.v("TempFileProvider", "uniqueIdentifier: "+uniqueIdentifier);
