...
import edu.bupt.mms.ui.MultiPartSmsTests;
import edu.bupt.mms.ui.SmsStressTest;
 ...
 * -e sendinterval 10 -w edu.bupt.mms.tests/edu.bupt.mms.SmsTestRunner
 */
public class SmsTestRunner extends InstrumentationTestRunner{
    ...
    // file used to store a message (under /data/data/edu.bupt.mms/files/)
    public String mMessageFileName = null;
    // file to store recipients separated by comma (/data/data/edu.bupt.mms/files/)
