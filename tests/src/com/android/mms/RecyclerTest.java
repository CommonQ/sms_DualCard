 ...
 *    example: adb push ~/words /data/data/edu.bupt.mms/files
 * and then push a file that contains a comma separated list of numbers to send to.
 *    example: adb push ~/recipients /data/data/edu.bupt.mms/files
 *
 */
/**
 * Bang on the recycler and test it getting called simultaneously from two different threads
 ...
 *    runtest --test-class=edu.bupt.mms.RecyclerTest mms
 */
public class RecyclerTest extends AndroidTestCase {
    ...
    protected void setUp() throws Exception {
        ...
        try {
            ...
            Log.e(TAG, "can't open words file at /data/data/edu.bupt.mms/files/words");
            return;
        }
        ...
        try {
            ...
            Log.e(TAG, "can't open recipients file at /data/data/edu.bupt.mms/files/recipients");
            return;
        }
